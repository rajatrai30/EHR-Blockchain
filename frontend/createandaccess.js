...
const HealthRecordAddress = "0xE0234DfF17b50fB4aae283dD5C4c2846Bf83dcCb";
...
async function addrecord() {
  ...
  const record = await recordContract
    .connect(signer)
    .insertRecord(
      patientID,
      hospitalName,
...
function insertinformationtable(
  pname,
  pid,
  page,
  pgender,
  ...
  tableEL.innerHTML +=
    ...
    pname +
    "</td></tr><tr><th>Patient ID:</th><td>" +
    pid +
    "</td></tr><tr><th>Age:</th><td>" +
    page +
    "</td></tr><tr><th>Gender:</th><td>" +
    pgender +
    "</td></tr><tr><th>Blood Type:</th><td>" +
    pblood +
    "</td></tr><tr><th>Mobile Number:</th><td>" +
    phno +
...
function insertrecordtable(
  ...
  tableEL.innerHTML +=
    ...
    hname +
    "</td></tr><tr><th>Doctor Name:</th><td>" +
    dname +
    "</td></tr><tr><th>Speciality:</th><td>" +
    special +
    "</td></tr><tr><th>Referred By:</th><td>" +
    referr +
    "</td></tr><tr><th>Complaints:</th><td>" +
    complain +
    "</td></tr><tr><th>Investigation Advise:</th><td>" +
    invest +
    "</td></tr><tr><th>Medicine Advice:</th><td>" +
    meds +
    "</td></tr><br>";
}
